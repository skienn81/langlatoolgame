...
if not os.path.exists(seed_jar):
    ...
    print()
    print("Chep file client_modded.jar vao GOC DU AN roi chay lai script nay:")
    print("   ", os.path.join(poc_dir, "client_modded.jar"))
    print()
    print("LAY FILE DO O DAU: xin tu nguoi dua ban bo tool nay.")
    print()
    print("DUNG mat cong tim jar trong thu muc game - KHONG CO. Ban game hien tai giu ma")
    print("trong META-INF/client.payload DA MA HOA, nap qua com.beatdz.protect.")
    print("ProtectedLauncher, nen doi duoi .exe thanh .zip roi giai nen chi ra lop vo bao ve.")
    print()
    print("LUU Y: ban game hai ben phai KHOP. Jar chua ma cua mot ban build cu the, ma mod do")
    print("vao cac lop da bi lam roi ten (a.ew, a.fm, a.z) - ten do doi theo tung ban.")
    print()
    print("Tu lan thu hai tro di khong can lam gi: script tu doc va ghi de len chinh file do.")
    print("Chi tiet: HUONG_DAN_SETUP.md, Buoc 2.")
    print("=" * 70)
    exit(1)
